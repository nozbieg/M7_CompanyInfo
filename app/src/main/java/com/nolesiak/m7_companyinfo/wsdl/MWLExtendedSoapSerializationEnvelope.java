...
public class MWLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://CIS/BIR/PUBL/2014/07/DataContract^^ParametryWyszukiwania",MWLParametryWyszukiwania.class);
    } 
    ...
    public static void setDateTimeConverter(MWLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MWLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MWLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MWLDateTimeConverter dateTimeConverter = new MWLStandardDateTimeConverter();

    public MWLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MWLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MWLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MWLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
				android.util.Log.e(MWLExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MWLExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MWLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
